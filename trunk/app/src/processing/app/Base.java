...
//    }
    ...
    try {
      ...
      System.err.println("Non-fatal error while setting the Look & Feel.");
      System.err.println("The error message follows, however Karat should run fine.");
      System.err.println(e.getMessage());
      //e.printStackTrace();
    }
  ...
  static protected void initRequirements() {
    try {
      ...
      Base.showError("Please install JDK 1.5 or later",
                     "Karat requires a full JDK (not just a JRE)\n" +
    ...
    if (sketchbookPath != null) {
      ...
      if (!skechbookFolder.exists()) {
        Base.showWarning("Sketchbook folder disappeared",
                         ...
                         "Karat will switch to the default sketchbook\n" +
                         "location, and create a new sketchbook folder if\n" +
                         "necessary. Karat will then stop talking about\n" +
...
//          (editor.untitled && !editor.getSketch().isModified())) {
      if (Base.isMacOS()) {
        ...
        String prompt =
          ...
          "<p>Closing the last open sketch will quit Karat.";
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if (new File(path).exists()) {
            ...
            showWarning("Sketch Does Not Exist",
                        ...
                        "You may need to restart Karat to update\n" +
  ...
  public void handleAbout() {
    ...
    final Window window = new Window(activeEditor) {
        public void paint(Graphics g) {
          ...
          g.drawString(Base.VERSION_NAME, 155, 50);
    ...
    if (preferencesPath != null) {
      ...
      try {
        ...
        showError("Problem getting data folder",
                  "Error getting the Karat data folder.", e);
      }
    }
    ...
    if (!settingsFolder.exists()) {
      if (!settingsFolder.mkdirs()) {
        showError("Settings issues",
                  "Karat cannot run because it could not\n" +
